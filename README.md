...
這裡提供下載的韌體檔案 是專門build給Waveshare ESP32-S3-Touch-AMOLED-1.75 or ESP32-S3 2.06寸 AMOLED 用的韌體 <BR>
...
可以參考該網址說明文件操作, 然後要燒錄的韌體bin檔 就是與此說明文件同目錄的esp-watch-175 or esp-watch-200 <BR>
esp-watch-175.bin (專門給Waveshare ESP32-S3-Touch-AMOLED-1.75用的喔)。<BR>
esp-watch-200.bin (專門給Waveshare ESP32-S3 2.06寸 AMOLED用的喔)。<BR>
